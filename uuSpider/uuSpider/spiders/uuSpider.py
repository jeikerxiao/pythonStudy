...
class QuanjiSpider(scrapy.Spider):
    ...
    def start_requests(self):
        return [Request("http://www.mayattt.com/logging.php?action=login", callback=self.post_login)]
    ...
    def after_login(self, response):
        ...
        for page_num in range(1, 41, 1):
            url = 'http://www.mayattt.com/forumdisplay.php?fid=5&page=' + str(page_num)
