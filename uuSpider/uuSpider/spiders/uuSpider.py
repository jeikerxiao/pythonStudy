...
class QuanjiSpider(scrapy.Spider):
    ...
    def start_requests(self):
        return [Request("http://www.baidu.com/logging.php?action=login", callback=self.post_login)]
    ...
    def after_login(self, response):
        ...
        for page_num in range(1, 41, 1):
            url = 'http://www.baidu.com/forumdisplay.php?fid=5&page=' + str(page_num)
    ...
    def parse(self, response):
        ...
        for item in items:
            url_str = 'http://www.baidu.com/'+item.xpath('./td[@class="f_title"]/a/@href').extract()[0]
            title_str = ''
            date_str = ''
            try:
